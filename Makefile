...
XTENSA_TOOLCHAIN := "xtensa-esp32-elf-linux64-1.22.0-75-gbaf03c2-5.2.0.tar.gz"

ifeq ($(UNAME), Darwin)
XTENSA_TOOLCHAIN := "xtensa-esp32-elf-osx-1.22.0-75-gbaf03c2-5.2.0.tar.gz"
endif

ESP_IDF_VERSION := "v3.0-rc1"
